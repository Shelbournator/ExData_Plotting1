...
## Script name: plot1.R
##
## Purpose of script: To download relevant data and create plot1.png.
##
...
#### --------------
# 3. Build plot 1: Histogram of Global Active Power.
#### --------------

png(file="plot1.png") # Initialize graphic device
